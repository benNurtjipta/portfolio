  ...
  return (
    <div className="outer-rim" ref={ref}>
      ...
      >
        <h4>ABOUT ME</h4>
        <p>
          Hi, I'm Ben — a web developer in the making. I’m finishing my studies
          at DCI Digital Career Institute (Nov 2025) and ready to take on new
          challenges.
        </p>
        <p>
          With a background in video editing and team leadership, I bring
          creative thinking, strong communication, and a collaborative mindset
          to the table.
        </p>
        <p>
          I'm passionate about music, curious about new tech, love good food,
